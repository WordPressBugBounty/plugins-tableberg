...
* FIX: An Image element with "Enlarge on click" enabled no longer crashes the page
* FIX: Activating Pro no longer shows a duplicated deactivation dialog or gets stuck
* IMPROVE: Updated the bundled Freemius licensing SDK
...
= 0.6.12 =
* FIX: XSS issue in button block

= 0.6.11 =
* FIX: Handle the case where Gutenberg edit-site is not available

= 0.6.10 =
* FIX: Check user authority before ajax calls

= 0.6.9 =
* NEW: Added pattern library
...
* FIX: PHP warning: Undefined array key "tableAlignment"
