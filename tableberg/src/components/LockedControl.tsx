    ...
    return (
        <>
            <div
                ...
                style={style}
            >
                <div className="tableberg-locked-children">{children}</div>
                <button
                    className="tableberg-lock-overlay"
                    onClick={() => setVisibility(true)}
                    aria-label="Unlock with Tableberg Pro"
                >
                    <span className="tableberg-lock-container">
